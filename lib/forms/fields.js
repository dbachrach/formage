...
var BaseField = exports.BaseField = Class.extend({
    ...
    get_description: function () {
        var description = _.humanize(this.description);
        return description;
    },
    render: function (res) {
    ...
    render_label: function (res) {
        ...
        res.write('<label for="id_' + this.name + '" class="' + class_str + '"><b>' + this.get_label() + '</b><br/>' + this.get_description() + '</label>\n');
    },
    render_with_label: function (res) {
        var mainClass = ['field', this.importance < 1 ? 'inline_hide' : '', this.inline ? 'inline' : ''].join(' ');
        res.write('<div class="' + mainClass + '">\n');
...
exports.ReadonlyField = BaseField.extend({
    init: function (options) {
        options = options || {};
...
exports.BooleanField = BaseField.extend({
    init: function (options) {
        options = options || {};
...
exports.EnumMultiField = EnumField.extend({
    init: function (options) {
        options = options || {};
...
exports.NumberField = StringField.extend({
    init: function (options) {
        options = options || {};
...
exports.TimeField = DateField.extend({
    init: function (options) {
        options = options || {};
 ...
 */
exports.FilepickerField = BaseField.extend({
    init: function (options) {
...
exports.PictureField = BaseField.extend({
    init: function (options) {
        options.widget = options.widget || Widgets.FilepickerPictureWidget;
        this._super(options);
        this.header_lines = [];
        var FILEPICKER_API_KEY = options.FILEPICKER_API_KEY || process.env.FILEPICKER_API_KEY;
        if (!FILEPICKER_API_KEY) console.error("Must supply Filepicker API key for field " + this.name);
        this.header_lines.push('<script src="//api.filepicker.io/v1/filepicker.js"></script>');
        this.header_lines.push('<script>filepicker.setKey("' + FILEPICKER_API_KEY + '");</script>');

        if (options.widget == 'AviaryWidget') {
            var AVIARY_API_KEY = options.AVIARY_API_KEY || process.env.AVIARY_API_KEY;
            if (!AVIARY_API_KEY) console.error("Must supply Aviary API key for field " + this.name);
            this.header_lines.push('<script>var AVIARY_API_KEY="' + AVIARY_API_KEY + '";</script>');
            this.header_lines.push('<script src="//feather.aviary.com/js/feather.js"></script>');
        }
...
exports.GeoPointField = BaseField.extend({
    init: function (options) {
        options = options || {};
...
exports.MixedField = BaseField.extend({
    init: function (options) {
        options = options || {};
